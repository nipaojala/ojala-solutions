...
export default function MobileMenu({ isOpen, onClose, children }: MobileMenuProps) {
  return (
    <>
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed top-20 left-0 right-0 bottom-0 z-40 md:hidden bg-linear-to-b from-[#A8DF8E] via-[#F0FFDF] to-[#FFD8DF] flex flex-col transition-all duration-300 ease-in-out ${
